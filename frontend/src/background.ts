...
const GOOGLE_SCRIPT_URL =
	"https://script.google.com/macros/s/AKfycbxuu5qZBmaHOQJZ43ASguQWZ0CxQpe4zmScdujQu9SBjh9yxD925JpzMq_NReSGRscw/exec";
...
async function handleSync(action: string, payload: object) {
	try {
		...
		console.log("BG sending", action, payload, "spreadsheetId", spreadsheetId);
